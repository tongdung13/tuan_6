                        ...
                        <div class="panel-body add_model_chose ">
                            <div class="mode_chose0">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <select class="form-control" name="category_id" id="inputSelect" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" name="category_name" id="inputText"
...
@section('script')
    <script type="text/javascript">
        ...
        function add_model_html() {
            ...
            strString += ' <div class="col-lg-10">';
            strString += '<select class="form-control" name="category_id" id="inputSelect" required>';
